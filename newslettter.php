					...
					<div class="col-md-12">
						...
						<div class="newsletter">
							...
							<ul class="newsletter-follow">
								<li>
									<a href="https://www.facebook.com/profile.php?id=100016399184237"><i class="fa fa-facebook"></i></a>
								</li>
								<!-- <li>
									<a href="https://github.com/puneethreddyhc"><i class="fa fa-twitter"></i></a>
								</li> -->
								<li>
									<a href="https://www.instagram.com/abhisheksingh210100/"><i class="fa fa-instagram"></i></a>
								</li>
								<!-- <li>
